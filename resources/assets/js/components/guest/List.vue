<template>
    <div>
       ...
       <flash-message :position="'right bottom'" :timeout="3000" class="myCustomClass"></flash-message>
        ...
        <portal to="guest_count">
            <div class="">
                <h1 class="admin-h1 my-3">Guests ( {{ Object.keys(this.users).length }} )</h1>
            </div>
        </portal>
        ...
        <div>
            ...
            <div class="my-8">
                <div class="w-full flex flex-wrap items-center justify-between mb-4">
                    <div class="flex items-center text-sm">
                        <div class="px-3 border-r" v-if="this.selectedUsersCount > 0">
                            {{ parseInt(this.selectedUsersCount) }} guests selected
                        </div>
                ...
                <div class="flex flex-wrap">
                    <div class="w-full xl:w-1/4 lg:w-1/3 md:w-1/2 my-2 relative" v-for="user in users">
...
<script>
    ...
    export default {
        ...
        created() 
        {
            axios.get('/admin/guests/find?'+this.searchquery).then(response => {
        ...
        methods:
        {
            ...
            getUrl()
            {
                this.currenturl =  this.url+"/admin/guests/"; 
                if(this.searchquery!='')
                {
            ...
            clearAll()
            {
                window.location.href = this.url+'/admin/guests';
            },
