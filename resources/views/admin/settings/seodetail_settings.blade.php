    ...
    <div class="px-3 py-3 mx-2">
        {{--<div class="my-3 py-1 px-2">
            <div class="">
                ...
                <div class="w-full lg:w-2/5 md:w-2/5 my-2">
                    ...
                    <span
                        class="text-danger text-xs text-red-500 py-1 font-semibold">{{ $errors->first('sitetitle') }}</span>
                </div>
            </div>
        </div>
        ...
        <div class="my-3 py-1 px-2">
            <div class="">
                ...
                <div class="w-full lg:w-2/5 md:w-2/5 my-2">
                    ...
                    <span
                        class="text-danger text-xs text-red-500 py-1 font-semibold">{{ $errors->first('site_description') }}</span>
                </div>
            </div>
        </div>
        ...
        <div class="my-3 py-1 px-2">
            <div class="">
                ...
                <div>
                    <p class="text-gray-500 text-xs py-1">Separate Each Keyword With A Comma</p>
                    <span
        ...
        <div class="my-3 py-1 px-2">
            <div class="">
                ...
                <span
                    class="text-danger text-xs text-red-500 py-1 font-semibold">{{ $errors->first('header_code') }}</span>
            </div>
        </div>
        ...
        <div class="my-3 py-1 px-2">
            <div class="">
                ...
                <span
                    class="text-danger text-xs text-red-500 py-1 font-semibold">{{ $errors->first('footer_code') }}</span>
            </div>
        </div>

        <div class="mt-6 mb-4 py-1 px-2">
            <input id="submit"
