...
<div class="w-full">
    <h1 class="admin-h1 mb-5 flex items-center">
        ...
        <span class="mx-3">Create Bulletin</span>
    </h1>

    @include('partials.message')

    <div class="bg-white shadow px-4 py-3">
        <form method="POST" action="{{ url('/admin/bulletin/create') }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="my-5" id="week-field" style="{{ old('type') === 'week' ? '' : 'display:none' }}">
                <div class="w-full lg:w-1/4">
                ...
                <div class="w-full lg:w-2/5 my-2">
                    <select name="week" id="week" class="tw-form-control w-full">
                        <option value="" disabled {{ old('week') ? '' : 'selected' }}>Select Week</option>
                        @for ($w = 1; $w <= 52; $w++)
            ...
            @endphp
            <div class="my-5" id="month-field" style="{{ old('type') === 'month' ? '' : 'display:none' }}">
                <div class="w-full lg:w-1/4">
            ...
            <div class="my-5">
                <div class="w-full lg:w-1/4">
                    <label for="path" class="tw-form-label">Bulletin File <span class="text-red-500">*</span></label>
                </div>
                <div class="w-full lg:w-2/5 my-2">
...
<script>
    ...
    (function() {
        ...
        var form = document.querySelector('form[action*="bulletin/create"]');
